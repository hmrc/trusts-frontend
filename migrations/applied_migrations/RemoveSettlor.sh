...
echo "GET        /:draftId/removeSettlor                        controllers.register.settlors.living_settlor.RemoveSettlorController.onPageLoad(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/removeSettlor                        controllers.register.settlors.living_settlor.RemoveSettlorController.onSubmit(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes

echo "GET        /:draftId/changeRemoveSettlor                  controllers.register.settlors.living_settlor.RemoveSettlorController.onPageLoad(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/changeRemoveSettlor                  controllers.register.settlors.living_settlor.RemoveSettlorController.onSubmit(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
