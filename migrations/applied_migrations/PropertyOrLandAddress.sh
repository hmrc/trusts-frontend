...
echo "GET        /:draftId/propertyOrLandAddress                        controllers.PropertyOrLandAddressController.onPageLoad(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/propertyOrLandAddress                        controllers.PropertyOrLandAddressController.onSubmit(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes

echo "GET        /:draftId/changePropertyOrLandAddress                  controllers.PropertyOrLandAddressController.onPageLoad(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/changePropertyOrLandAddress                  controllers.PropertyOrLandAddressController.onSubmit(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
