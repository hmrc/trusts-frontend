...
echo "GET        /registeringTrustFor5A                        controllers.register.trust_details.RegisteringTrustFor5AController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /registeringTrustFor5A                        controllers.register.trust_details.RegisteringTrustFor5AController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeRegisteringTrustFor5A                  controllers.register.trust_details.RegisteringTrustFor5AController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeRegisteringTrustFor5A                  controllers.register.trust_details.RegisteringTrustFor5AController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
