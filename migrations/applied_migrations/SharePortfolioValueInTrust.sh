...
echo "GET        /sharePortfolioValueInTrust                        controllers.register.asset.shares.SharePortfolioValueInTrustController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /sharePortfolioValueInTrust                        controllers.register.asset.shares.SharePortfolioValueInTrustController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSharePortfolioValueInTrust                  controllers.register.asset.shares.SharePortfolioValueInTrustController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSharePortfolioValueInTrust                  controllers.register.asset.shares.SharePortfolioValueInTrustController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
