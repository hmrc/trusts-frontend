...
echo "GET        /settlorsUKAddress                        controllers.register.settlors.deceased_settlor.SettlorsUKAddressController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /settlorsUKAddress                        controllers.register.settlors.deceased_settlor.SettlorsUKAddressController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSettlorsUKAddress                  controllers.register.settlors.deceased_settlor.SettlorsUKAddressController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSettlorsUKAddress                  controllers.register.settlors.deceased_settlor.SettlorsUKAddressController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
