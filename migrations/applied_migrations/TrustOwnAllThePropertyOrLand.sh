...
echo "GET        /:draftId/trustOwnAllThePropertyOrLand                        controllers.TrustOwnAllThePropertyOrLandController.onPageLoad(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/trustOwnAllThePropertyOrLand                        controllers.TrustOwnAllThePropertyOrLandController.onSubmit(mode: Mode = NormalMode, draftId: String)" >> ../conf/app.routes

echo "GET        /:draftId/changeTrustOwnAllThePropertyOrLand                  controllers.TrustOwnAllThePropertyOrLandController.onPageLoad(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
echo "POST       /:draftId/changeTrustOwnAllThePropertyOrLand                  controllers.TrustOwnAllThePropertyOrLandController.onSubmit(mode: Mode = CheckMode, draftId: String)" >> ../conf/app.routes
