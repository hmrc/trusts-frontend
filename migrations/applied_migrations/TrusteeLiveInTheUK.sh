...
echo "GET        /trusteeLiveInTheUK                        controllers.register.trustees.individual.TrusteeLiveInTheUKController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /trusteeLiveInTheUK                        controllers.register.trustees.individual.TrusteeLiveInTheUKController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeTrusteeLiveInTheUK                  controllers.register.trustees.individual.TrusteeLiveInTheUKController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeTrusteeLiveInTheUK                  controllers.register.trustees.individual.TrusteeLiveInTheUKController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
