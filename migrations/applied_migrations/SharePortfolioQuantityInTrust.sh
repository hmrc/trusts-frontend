...
echo "GET        /sharePortfolioQuantityInTrust                        controllers.SharePortfolioQuantityInTrustController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /sharePortfolioQuantityInTrust                        controllers.SharePortfolioQuantityInTrustController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSharePortfolioQuantityInTrust                  controllers.SharePortfolioQuantityInTrustController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSharePortfolioQuantityInTrust                  controllers.SharePortfolioQuantityInTrustController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
