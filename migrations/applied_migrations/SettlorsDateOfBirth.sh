...
echo "GET        /settlorsDateOfBirth                  controllers.register.settlors.deceased_settlor.SettlorsDateOfBirthController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /settlorsDateOfBirth                  controllers.register.settlors.deceased_settlor.SettlorsDateOfBirthController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSettlorsDateOfBirth                        controllers.register.settlors.deceased_settlor.SettlorsDateOfBirthController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSettlorsDateOfBirth                        controllers.register.settlors.deceased_settlor.SettlorsDateOfBirthController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
