...
echo "GET        /shareCompanyName                        controllers.ShareCompanyNameController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /shareCompanyName                        controllers.ShareCompanyNameController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeShareCompanyName                  controllers.ShareCompanyNameController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeShareCompanyName                  controllers.ShareCompanyNameController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
