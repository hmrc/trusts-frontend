...
echo "GET        /settlorsName                        controllers.SettlorsNameController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /settlorsName                        controllers.SettlorsNameController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSettlorsName                  controllers.SettlorsNameController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSettlorsName                  controllers.SettlorsNameController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
