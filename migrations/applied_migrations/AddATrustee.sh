...
echo "GET        /addATrustee                        controllers.AddATrusteeController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /addATrustee                        controllers.AddATrusteeController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeAddATrustee                  controllers.AddATrusteeController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeAddATrustee                  controllers.AddATrusteeController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
