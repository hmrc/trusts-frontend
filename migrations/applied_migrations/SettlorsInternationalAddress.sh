...
echo "GET        /settlorsInternationalAddress                        controllers.SettlorsInternationalAddressController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /settlorsInternationalAddress                        controllers.SettlorsInternationalAddressController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSettlorsInternationalAddress                  controllers.SettlorsInternationalAddressController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSettlorsInternationalAddress                  controllers.SettlorsInternationalAddressController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
