...
echo "GET        /sharePortfolioName                        controllers.register.asset.shares.SharePortfolioNameController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /sharePortfolioName                        controllers.register.asset.shares.SharePortfolioNameController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeSharePortfolioName                  controllers.register.asset.shares.SharePortfolioNameController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeSharePortfolioName                  controllers.register.asset.shares.SharePortfolioNameController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
