...
accessibilityStatement.p3 = Mae’r dudalen hon yn cynnwys gwybodaeth am y gwasanaeth Cofrestru Ymddiriedolaeth a’i Chynnal yn unig, sydd ar gael yn tax.service.gov.uk.
...
accessibilityStatement.this.service.is.run.b1 =	newid lliwiau, lefelau cyferbyniad a ffontiau
...
accessibilityStatement.this.service.is.run.b5 =	gwrando ar y gwasanaeth gan ddefnyddio darllenydd sgrin (gan gynnwys y fersiynau diweddaraf o JAWS, NVDA a VoiceOver)
...
accessibilityStatement.ability.net.has.advice =	Mae gan AbilityNet gyngor ar wneud eich dyfais yn haws i’w defnyddio os oes gennych anabledd.
...
accessibilityStatement.some.people.may.find	= Mae’n bosibl y bydd rhai pobl yn cael anhawster defnyddio rhannau o’r gwasanaeth hwn:
...
accessibilityStatement.some.people.may.find.b2 = Efallai na fydd defnyddwyr yn cael eu cyfeirio at dudalen newydd wrth glicio ar gysylltiad
accessibilityStatement.some.people.may.find.b3 = Efallai na fydd defnyddwyr yn gallu defnyddio cwymplen gwlad gyda bar gofod eu bysellfwrdd; efallai y bydd yn rhaid iddynt glicio ar y maes mewnbwn gyda llygoden neu lywio gyda saethau’r bysellfwrdd i ddechrau teipio
...
accessibilityStatement.some.people.may.find.b6 = Efallai na fydd defnyddwyr darllenwyr sgrin ac offer cynorthwyol eraill yn ymwybodol o bwrpas ‘golygu cysylltiadau’ ar y dudalen

accessibilityStatement.reporting.problems =	Rhoi gwybod am broblemau hygyrchedd gyda’r gwasanaeth hwn
accessibilityStatement.reporting.pre.link =	Rydym bob amser yn ceisio gwella hygyrchedd y gwasanaeth hwn. Os byddwch yn dod o hyd i unrhyw broblem nad yw wedi’i rhestru ar y dudalen hon, neu os ydych o’r farn nad ydym yn bodloni gofynion hygyrchedd, rhowch wybod am y
...
accessibilityStatement.we.provide.a.text = Rydym yn cynnig gwasanaeth ‘text relay’ os ydych yn fyddar, â nam ar eich clyw neu os oes gennych nam ar eich lleferydd.
accessibilityStatement.we.can.provide = Gallwn ddarparu dehonglydd Iaith Arwyddion Prydain (BSL), neu gallwch drefnu ymweliad gan un o ymgynghorwyr CThEM i’ch helpu i gwblhau’r gwasanaeth.

accessibilityStatement.find.out.how	= Cael gwybod sut i
...
accessibilityStatement.hmrc.is.committed = Mae CThEM wedi ymrwymo i wneud y gwasanaeth hwn yn hygyrch, yn unol â Rheoliadau Hygyrchedd Cyrff Sector Cyhoeddus (Gwefannau a Chymwysiadau Symudol) (Rhif 2) 2018.
...
accessibilityStatement.non.compliance.info.pre.link	= Mae’r gwasanaeth yn defnyddio meysydd mewnbwn i gasglu enwau unigolion, gan ofyn am eu henw cyntaf, unrhyw enwau canol a’u henw olaf. Nid yw’r meysydd mewnbwn hyn wedi’u grwpio gyda’i gilydd. Nid yw hyn yn bodloni maen prawf llwyddiant 1.3.1 Info and Relationships AA
accessibilityStatement.non.compliance.info.link	= (Level A) Canllawiau Hygyrchedd Cynnwys y We,
accessibilityStatement.non.compliance.info.post.link = fersiwn 2.1. Rydym yn bwriadu ychwanegu disgrifiad at y rheolyddion ffurflenni hyn erbyn mis Hydref 2020.
...
accessibilityStatement.non.compliance.keyboard.link	= (Level A)
accessibilityStatement.non.compliance.keyboard.post.link = 2.4.1 Bypass Blocks
accessibilityStatement.non.compliance.bypass.link = (Level A)
accessibilityStatement.non.compliance.bypass.post.link = Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1. Rydym yn bwriadu sicrhau bod bysellfyrddau yn gallu mewnbynnu gwledydd erbyn mis Hydref 2020.
accessibilityStatement.non.compliance.change.pre.link = Mae’r gwasanaeth yn defnyddio cysylltiadau newid i alluogi defnyddwyr i olygu eu hatebion wrth wirio tudalennau crynodeb. Ni ellir pennu pwrpas pob cysylltiad ar sail testun y cysylltiadau yn unig. Nid yw hyn yn bodloni maen prawf llwyddiant 2.4.4 Link Purpose (In Context) AA
accessibilityStatement.non.compliance.change.link = (Level A)
accessibilityStatement.non.compliance.change.post.link = Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1. Rydym yn bwriadu addasu testun y cysylltiadau newid erbyn mis Hydref 2020.
