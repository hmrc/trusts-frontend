...
class SettlorDetailsSpec extends WordSpec with MustMatchers with PropertyChecks with OptionValues {
    ...
    "serialise" in {
      ...
      forAll(gen) {
        settlorDetails =>
          ...
          Json.toJson(settlorDetails) mustEqual JsString(settlorDetails.toString)
      }
    }
  }
}
