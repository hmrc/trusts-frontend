...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryPropertyOrLandAddressUserAnswersEntry: Arbitrary[(PropertyOrLandAddressPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[PropertyOrLandAddressPage.type]
