...
trait PageGenerators {
  ...
  implicit lazy val arbitraryIndividualBeneficiaryIsAddressUKPage: Arbitrary[IndividualBeneficiaryIsAddressUKPage.type] =
    Arbitrary(IndividualBeneficiaryIsAddressUKPage)
