    ...
    "Trustee Companies" - {
      ...
      "when there are companies" - {
        ...
        "with minimum data must return user answers updated" in {
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(0)) mustNot be(defined)
        ...
        "with full data must return user answers updated" in {
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(1)) mustNot be(defined)
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(2)).get mustBe true
        }
    ...
    "Trustee Individuals" - {
      ...
      "when there are individuals" - {
        ...
        "with full data must return user answers updated" in {
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(1)).get mustBe false
    ...
    "Combined Trustee Individuals & Trustee Companies" - {
      ...
      "when there are trustees" - {
        ...
        "must return user answers updated" in {
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(2)).get mustBe false
          ...
          extraction.right.value.get(TrusteeAddressUkYesNoPage(3)) mustNot be(defined)
