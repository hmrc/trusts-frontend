...
class LivingSettlorMapperSpec extends FreeSpec with MustMatchers
  with OptionValues with Generators with SpecBaseHelpers  {

  val livingSettlorMapper: Mapping[Settlor] = injector.instanceOf[LivingSettlorMapper]
  ...
  "LivingSettlorMapper" - {
    ...
    "when user answers is empty" - {
      ...
      "must not be able to create Deceased Settlor" in {
        ...
        livingSettlorMapper.build(userAnswers) mustNot be(defined)
      }
    }
...
//
//        livingSettlorMapper.build(userAnswers).value mustBe WillType(
...
//            .set(SetupAfterSettlorDiedPage, true).success.value
//
//        livingSettlorMapper.build(userAnswers) mustBe None
//
//      }
//
//    }
