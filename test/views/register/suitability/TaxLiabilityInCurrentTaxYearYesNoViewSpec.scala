...
class TaxLiabilityInCurrentTaxYearYesNoViewSpec extends YesNoViewBehaviours {
  ...
  "TaxLiabilityInCurrentTaxYearYesNo View" must {
    ...
    behave like dynamicTitlePage(applyView(form), messageKeyPrefix, Seq(currentTaxYearStartAndEnd._1, currentTaxYearStartAndEnd._2))

    behave like pageWithBackLink(applyView(form))

    behave like yesNoPage(form, applyView, messageKeyPrefix, None, Seq(currentTaxYearStartAndEnd._1, currentTaxYearStartAndEnd._2))
