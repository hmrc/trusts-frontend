...
class UndeclaredTaxLiabilityYesNoViewSpec extends YesNoViewBehaviours {

  private val messageKeyPrefix = "suitability.undeclaredTaxLiability"

  override val form: Form[Boolean] = new YesNoFormProvider().withPrefix(messageKeyPrefix)

  "UndeclaredTaxLiabilityYesNo View" must {

    val view = viewFor[UndeclaredTaxLiabilityYesNoView](Some(emptyUserAnswers))
