...
class SettlorsNINoYesNoViewSpec extends YesNoViewBehaviours {
  ...
  val form = new SettlorsNINoYesNoFormProvider()()
  ...
  "SettlorsNINoYesNo view" must {
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, routes.SettlorsNINoYesNoController.onSubmit(NormalMode, fakeDraftId).url,
      None, Seq(name.toString))
