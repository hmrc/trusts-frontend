...
class IndividualBeneficiaryAddressYesNoViewSpec extends YesNoViewBehaviours {
  ...
  "IndividualBeneficiaryAddressYesNo view" must {
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, routes.IndividualBeneficiaryAddressYesNoController.onSubmit(NormalMode, index, fakeDraftId).url, None, Seq(fullName.toString))
