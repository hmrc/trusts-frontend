...
class ShareValueInTrustFormProviderSpec extends StringFieldBehaviours with IntFieldBehaviours {

  val requiredKey = "shareValueInTrust.error.required"
  val lengthKey = "shareValueInTrust.error.length"
  val maxLength = 12
  val zeroNumberkey = "shareValueInTrust.error.zero"
