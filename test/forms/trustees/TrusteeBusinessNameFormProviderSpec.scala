...
class TrusteeBusinessNameFormProviderSpec extends StringFieldBehaviours {
  ...
  val requiredKey = "trusteeBusinessName.error.required"
  val lengthKey = "trusteeBusinessName.error.length"
  val invalidFormatKey = "trusteeBusinessName.error.invalidFormat"
  val maxLength = 56
