...
class SettlorIndividualNINOYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorIndividualNINOYesNoRoute = routes.SettlorIndividualNINOYesNoController.onPageLoad(NormalMode, fakeDraftId).url
  ...
  "SettlorIndividualNINOYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SettlorIndividualNINOYesNoPage, true).success.value
