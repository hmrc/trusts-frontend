...
class SettlorIndividualAddressUKYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorIndividualAddressUKYesNoRoute = routes.SettlorIndividualAddressUKYesNoController.onPageLoad(NormalMode, fakeDraftId).url
  ...
  "SettlorIndividualAddressUKYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SettlorIndividualAddressUKYesNoPage, true).success.value
