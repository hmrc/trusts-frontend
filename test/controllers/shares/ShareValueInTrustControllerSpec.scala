...
import pages.shares.{ShareCompanyNamePage, ShareValueInTrustPage}
import play.api.inject.bind
import play.api.mvc.{AnyContentAsEmpty, AnyContentAsFormUrlEncoded, Call}
import play.api.test.FakeRequest
import play.api.test.Helpers.{route, _}
import views.html.shares.ShareValueInTrustView
...
class ShareValueInTrustControllerSpec extends SpecBase with ModelGenerators with IndexValidation {
  ...
  lazy val shareValueInTrustRoute = controllers.shares.routes.ShareValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a GET" must {
    ...
    def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
      val route = controllers.shares.routes.ShareValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a POST" must {
    def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
      ...
      val route =
        controllers.shares.routes.ShareValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
