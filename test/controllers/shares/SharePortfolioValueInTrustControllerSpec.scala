...
import pages.shares.SharePortfolioValueInTrustPage
...
class SharePortfolioValueInTrustControllerSpec extends SpecBase with ModelGenerators with IndexValidation {
  ...
  lazy val sharePortfolioValueInTrustRoute = controllers.shares.routes.SharePortfolioValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a GET" must {
    ...
    def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
      val route = controllers.shares.routes.SharePortfolioValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a POST" must {
    def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
      ...
      val route =
        controllers.shares.routes.SharePortfolioValueInTrustController.onPageLoad(NormalMode, index, fakeDraftId).url
