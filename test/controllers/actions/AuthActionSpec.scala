...
class AuthActionSpec extends SpecBase {
  ...
  private val agentEnrolment = Enrolments(Set(
    Enrolment(
      "HMRC-AS-AGENT",
      List(EnrolmentIdentifier("SomeKey","SomeVal")),
      "Activated",
      None
    )
  ))
  ...
  "Auth Action" when {
    ...
    "Agent user hasn't enrolled in Agent Services Account" must {
      ...
      "redirect the user to the create agent services page" in {
        ...
        val authAction = new AuthenticatedIdentifierAction(
          FakeAuthConnector.stubbed(agentAffinityGroup, noEnrollment),
          frontendAppConfig, bodyParsers
        )
    ...
    "Agent user has correct enrolled in Agent Services Account" must {
      ...
      "allow user to continue" in {
        ...
        val authAction = new AuthenticatedIdentifierAction(
          FakeAuthConnector.stubbed(agentAffinityGroup, agentEnrolment),
          frontendAppConfig,
          bodyParsers
        )
    ...
    "Org user with no enrolments" must {
      ...
      "allow user to continue" in {
        ...
        val authAction = new AuthenticatedIdentifierAction(
          FakeAuthConnector.stubbed(orgAffinityGroup, noEnrollment),
          frontendAppConfig,
          bodyParsers
        )
    ...
    "Individual user" must {
      ...
      "redirect the user to the unauthorised page" in {
        ...
        val authAction = new AuthenticatedIdentifierAction(
          FakeAuthConnector.stubbed(AffinityGroup.Individual, noEnrollment),
          frontendAppConfig,
          bodyParsers
        )
