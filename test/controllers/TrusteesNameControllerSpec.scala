...
class TrusteesNameControllerSpec extends SpecBase {
  ...
  lazy val trusteesNameRoute = routes.TrusteesNameController.onPageLoad(NormalMode).url
  ...
  "TrusteesName Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(TrusteesNamePage, "answer").success.value
