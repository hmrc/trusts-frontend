...
class SettlorDateOfDeathYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorDateOfDeathYesNoRoute = routes.SettlorDateOfDeathYesNoController.onPageLoad(NormalMode).url
  ...
  "SettlorDateOfDeathYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(SettlorDateOfDeathYesNoPage, true).success.value.set(SettlorsNamePage,FullName("first name", None, "Last name")).success.value
