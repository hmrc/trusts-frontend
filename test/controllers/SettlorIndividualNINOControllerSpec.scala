...
class SettlorIndividualNINOControllerSpec extends SpecBase {
  ...
  lazy val settlorIndividualNINORoute = routes.SettlorIndividualNINOController.onPageLoad(NormalMode, fakeDraftId).url
  ...
  "SettlorIndividualNINO Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SettlorIndividualNINOPage, "answer").success.value
