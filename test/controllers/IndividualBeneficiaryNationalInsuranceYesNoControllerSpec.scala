...
class IndividualBeneficiaryNationalInsuranceYesNoControllerSpec extends SpecBase {
  ...
  lazy val individualBeneficiaryNationalInsuranceYesNoRoute = routes.IndividualBeneficiaryNationalInsuranceYesNoController.onPageLoad(NormalMode, index).url
  ...
  "IndividualBeneficiaryNationalInsuranceYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(IndividualBeneficiaryNationalInsuranceYesNoPage(index), true).success.value
