...
class IndividualBeneficiaryNationalInsuranceYesNoControllerSpec extends SpecBase {
  ...
  val formProvider = new IndividualBeneficiaryNationalInsuranceYesNoFormProvider()
  val form = formProvider()

  lazy val individualBeneficiaryNationalInsuranceYesNoRoute = routes.IndividualBeneficiaryNationalInsuranceYesNoController.onPageLoad(NormalMode).url
  ...
  "IndividualBeneficiaryNationalInsuranceYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(IndividualBeneficiaryNationalInsuranceYesNoPage, true).success.value
