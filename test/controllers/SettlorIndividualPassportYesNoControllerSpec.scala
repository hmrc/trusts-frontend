...
class SettlorIndividualPassportYesNoControllerSpec extends SpecBase {
  ...
  lazy val settlorIndividualPassportYesNoRoute = routes.SettlorIndividualPassportYesNoController.onPageLoad(NormalMode, fakeDraftId).url
  ...
  "SettlorIndividualPassportYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SettlorIndividualPassportYesNoPage, true).success.value
