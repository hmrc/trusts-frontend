...
import pages.register.RegisteringTrustFor5APage
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.RegisteringTrustFor5AView

class RegisteringTrustFor5AControllerSpec extends RegistrationSpecBase {
