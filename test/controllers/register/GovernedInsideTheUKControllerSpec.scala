...
import pages.register.GovernedInsideTheUKPage
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.GovernedInsideTheUKView

class GovernedInsideTheUKControllerSpec extends RegistrationSpecBase {
