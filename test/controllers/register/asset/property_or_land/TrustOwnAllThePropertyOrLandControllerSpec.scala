...
class TrustOwnAllThePropertyOrLandControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "TrustOwnAllThePropertyOrLand Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), NormalMode, index, fakeDraftId)(request, messages).toString
