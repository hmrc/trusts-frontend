...
class SharesOnStockExchangeControllerSpec extends RegistrationSpecBase with ModelGenerators with IndexValidation {
  ...
  "SharesOnStockExchange Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), NormalMode, fakeDraftId, index, companyName)(request, messages).toString
