...
import views.html.register.asset.buisness.AssetAddressUkYesNoView
import views.html.register.trustees.organisation.TrusteeOrgAddressUkYesNoView


class AssetAddressUkYesNoControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  lazy val businessAssetAddressUkYesNoRoute = routes.AssetAddressUkYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url

  "AssetAddressUkYesNoController Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[AssetAddressUkYesNoView]
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.AssetAddressUkYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
