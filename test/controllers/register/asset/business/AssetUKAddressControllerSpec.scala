...
class AssetUKAddressControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  lazy val assetUkAddressRoute: String = routes.AssetUkAddressController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "AssetUkAddress Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[AssetUkAddressView]
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.AssetUkAddressController.onPageLoad(NormalMode, index, fakeDraftId).url
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.AssetUkAddressController.onPageLoad(NormalMode, index, fakeDraftId).url
