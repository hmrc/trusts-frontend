...
class BusinessValueControllerSpec extends RegistrationSpecBase {
  ...
  lazy val currentValueRoute = routes.BusinessValueController.onPageLoad(NormalMode, index, fakeDraftId).url
