...
import views.html.register.asset.buisness.AssetNameView
import views.html.register.trustees.organisation.TrusteeBusinessNameView

class AssetNameControllerSpec extends RegistrationSpecBase  with IndexValidation {

  val formProvider = new TrusteeBusinessNameFormProvider()
  val form = formProvider()
  val index = 0

  lazy val assetNameRoute = routes.AssetNameController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "AssetName Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[AssetNameView]
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.AssetNameController.onPageLoad(NormalMode, index, fakeDraftId).url
    ...
    "for a POST" must {
      ...
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.AssetNameController.onPageLoad(NormalMode, index, fakeDraftId).url
