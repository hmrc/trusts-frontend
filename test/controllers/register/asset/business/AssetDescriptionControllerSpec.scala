...
class AssetDescriptionControllerSpec extends RegistrationSpecBase  with IndexValidation {

  val formProvider = new AssetDescriptionFormProvider()
  val form = formProvider()
  val index = 0
  val buisnessName = "Test"

  lazy val assetDescriptionRoute = routes.AssetDescriptionController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "assetDescription Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[AssetDescriptionView]
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.AssetDescriptionController.onPageLoad(NormalMode, index, fakeDraftId).url
    ...
    "for a POST" must {
      ...
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.AssetDescriptionController.onPageLoad(NormalMode, index, fakeDraftId).url
