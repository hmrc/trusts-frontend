...
class HowDeedOfVariationCreatedControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "HowDeedOfVariationCreated Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(DeedOfVariation.values.head), NormalMode, fakeDraftId)(fakeRequest, messages).toString
