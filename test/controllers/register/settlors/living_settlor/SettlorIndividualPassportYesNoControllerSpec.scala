...
import pages.register.settlors.living_settlor.{SettlorIndividualNamePage, SettlorIndividualPassportYesNoPage}
  ...
  "SettlorIndividualPassportYesNo Controller" must {
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.SettlorIndividualPassportYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
      ...
      validateIndex(
        arbitrary[Boolean],
        SettlorIndividualPassportYesNoPage.apply,
        getForIndex
      )
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.SettlorIndividualPassportYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
