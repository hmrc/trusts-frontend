...
import pages.register.settlors.living_settlor.business.{SettlorBusinessAddressUKPage, SettlorBusinessNamePage}
import play.api.mvc.{AnyContentAsEmpty, AnyContentAsFormUrlEncoded, Call}
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.settlors.living_settlor.business.SettlorBusinessAddressUKView

class SettlorBusinessAddressUKControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "SettlorBusinessAddressUK Controller" must {
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.SettlorBusinessAddressUKController.onPageLoad(NormalMode, index, fakeDraftId).url
      ...
      validateIndex(
        arbitrary[UKAddress],
        SettlorBusinessAddressUKPage.apply,
        getForIndex
      )
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.SettlorBusinessAddressUKController.onPageLoad(NormalMode, index, fakeDraftId).url
