...
class SettlorBusinessAddressUKYesNoControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "SettlorBusinessAddressUKYesNo Controller" must {
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.SettlorBusinessAddressUKYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
      ...
      validateIndex(
        arbitrary[Boolean],
        SettlorBusinessAddressUKYesNoPage.apply,
        getForIndex
      )
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.SettlorBusinessAddressUKYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
