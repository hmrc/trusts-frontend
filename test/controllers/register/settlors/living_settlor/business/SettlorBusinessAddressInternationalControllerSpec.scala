...
import views.html.register.settlors.living_settlor.business.SettlorBusinessAddressInternationalView

import scala.concurrent.Future

class SettlorBusinessAddressInternationalControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "SettlorBusinessAddressInternational Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(InternationalAddress("line 1", "line 2", Some("line 3"), "country")), countryOptions, NormalMode, index, fakeDraftId, name)(fakeRequest, messages).toString
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.SettlorBusinessAddressInternationalController.onPageLoad(NormalMode, index, fakeDraftId).url
      ...
      validateIndex(
        ...
        SettlorBusinessAddressInternationalPage.apply,
        getForIndex
      )
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.SettlorBusinessAddressInternationalController.onPageLoad(NormalMode, index, fakeDraftId).url
