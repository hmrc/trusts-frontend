...
import pages.register.settlors.living_settlor.business.{SettlorBusinessTimeYesNoPage, SettlorBusinessNamePage}
import play.api.mvc.{AnyContentAsEmpty, AnyContentAsFormUrlEncoded, Call}
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.settlors.living_settlor.business.SettlorBusinessTimeYesNoView

class SettlorBusinessTimeYesNoControllerSpec extends RegistrationSpecBase with IndexValidation {
  ...
  "SettlorBusinessTimeYesNo Controller" must {
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.SettlorBusinessTimeYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
      ...
      validateIndex(
        arbitrary[Boolean],
        SettlorBusinessTimeYesNoPage.apply,
        getForIndex
      )
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.SettlorBusinessTimeYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
