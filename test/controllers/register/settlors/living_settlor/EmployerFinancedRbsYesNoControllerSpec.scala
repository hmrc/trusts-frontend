...
import pages.register.settlors.living_settlor.trust_type.EfrbsYesNoPage
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.settlors.living_settlor.EmployerFinancedRbsYesNoView

class EmployerFinancedRbsYesNoControllerSpec extends RegistrationSpecBase with IndexValidation {
