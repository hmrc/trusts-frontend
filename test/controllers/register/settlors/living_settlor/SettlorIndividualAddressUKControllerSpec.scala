...
import views.html.register.settlors.living_settlor.SettlorIndividualAddressUKView

class SettlorIndividualAddressUKControllerSpec extends RegistrationSpecBase with IndexValidation {
