...
class PropertyOrLandAddressYesNoControllerSpec extends SpecBase with IndexValidation {
  ...
  val formProvider = new PropertyOrLandAddressYesNoFormProvider()
  ...
  "for a GET" must {
    ...
    def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
      val route = controllers.property_or_land.routes.PropertyOrLandAddressYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a POST" must {
    def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
      ...
      val route =
        controllers.property_or_land.routes.PropertyOrLandAddressYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
