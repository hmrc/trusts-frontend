...
class PropertyOrLandAddressControllerSpec extends SpecBase with ModelGenerators with IndexValidation {
  ...
  lazy val propertyOrLandAddressRoute = routes.PropertyOrLandAddressController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "for a GET" must {
    ...
    def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
      val route = controllers.shares.routes.SharePortfolioOnStockExchangeController.onPageLoad(NormalMode, index, fakeDraftId).url
    ...
    validateIndex(
      arbitrary[Boolean],
      PropertyOrLandAddressPage.apply,
      getForIndex
    )
  ...
  "for a POST" must {
    def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
      ...
      val route =
        controllers.shares.routes.SharePortfolioOnStockExchangeController.onPageLoad(NormalMode, index, fakeDraftId).url
