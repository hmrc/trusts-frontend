...
class TrustSettledDateControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = trustSettledDate(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "TrustSettledDate Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(TrustSettledDatePage.toString -> JsString(testAnswer))
