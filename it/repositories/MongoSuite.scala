...
trait MongoSuite extends ScalaFutures {
  ...
  private val connectionString = "mongodb://localhost:27017/trusts-frontend-it"

  private def getDatabase(connection: MongoConnection): Future[DefaultDB] = {
    connection.database("trusts-frontend-integration")
  }
  ...
  protected def dropTheDatabase(connection: MongoConnection): Future[Unit] = {
