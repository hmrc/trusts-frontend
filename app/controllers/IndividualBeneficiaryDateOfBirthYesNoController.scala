...
import pages.{IndividualBeneficiaryDateOfBirthYesNoPage, IndividualBeneficiaryNamePage, SettlorsNamePage}
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          } yield Redirect(navigator.nextPage(IndividualBeneficiaryDateOfBirthYesNoPage(index), mode)(updatedAnswers))
        }
      )
  }
}
