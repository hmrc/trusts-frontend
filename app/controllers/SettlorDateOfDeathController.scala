...
import pages.{IsThisLeadTrusteePage, SettlorDateOfDeathPage, SettlorsNamePage, Trustees, TrusteesNamePage}
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          } yield Redirect(navigator.nextPage(SettlorDateOfDeathPage, mode)(updatedAnswers))
        }
      )
  }
}
