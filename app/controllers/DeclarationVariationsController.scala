...
import forms.DeclarationVariationsFormProvider
...
import pages.{DeclarationVariationsPage, RegistrationSubmissionDatePage, RegistrationTRNPage}
...
import views.html.DeclarationVariationsView

import scala.concurrent.{ExecutionContext, Future}
import scala.util.control.NonFatal

class DeclarationVariationsController @Inject()(
                                       ...
                                       formProvider: DeclarationVariationsFormProvider,
                                       val controllerComponents: MessagesControllerComponents,
                                       view: DeclarationVariationsView,
  ...
  def onPageLoad(mode: Mode, draftId: String): Action[AnyContent] = actions(draftId) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(DeclarationVariationsPage) match {
        case None => form
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
           ...
           val r = for {
              updatedAnswers <- Future.fromTry(request.userAnswers.set(DeclarationVariationsPage, value))
