...
class AddABeneficiaryYesNoController @Inject()(
                                         ...
                                         formProvider: AddABeneficiaryYesNoFormProvider,
                                         val controllerComponents: MessagesControllerComponents,
                                         view: AddABeneficiaryYesNoView
  ...
  def onPageLoad(mode: Mode, draftId: String): Action[AnyContent] = (identify andThen getData(draftId) andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(AddABeneficiaryYesNoPage) match {
        case None => form
