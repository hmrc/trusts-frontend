...
import services.{AgentAuthenticationService, AgentAuthenticationServiceImpl}
...
class Module extends AbstractModule {
  ...
  override def configure(): Unit = {
    ...
    bind(classOf[AgentAuthenticationService]).to(classOf[AgentAuthenticationServiceImpl]).asEagerSingleton()
