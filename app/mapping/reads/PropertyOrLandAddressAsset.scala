...
trait PropertyOrLandAsset

final case class PropertyOrLandAddressAsset(override val whatKindOfAsset: WhatKindOfAsset,
                                            propertyOrLandAddressYesNo: Boolean,
                                            address: UKAddress,
...
object PropertyOrLandAddressAsset {

  import play.api.libs.functional.syntax._

  implicit lazy val reads: Reads[PropertyOrLandAddressAsset] = {

    val propertyOrLandReads : Reads[PropertyOrLandAddressAsset] = Json.reads[PropertyOrLandAddressAsset]
