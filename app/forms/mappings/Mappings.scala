...
trait Mappings extends Formatters with Constraints {
  ...
  protected def localDateMapping(
  ...
  protected def localDateMapping: Mapping[LocalDate] =
    localDateMapping(defaultLocalDateMapping)

  protected def localDateMapping(subMapping: Mapping[(Int, Int, Int)]): Mapping[LocalDate] = {
